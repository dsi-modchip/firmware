 ...
 *  \defgroup pico_stdio_uart_dma pico_stdio_uart_dma
 *  \ingroup pico_stdio
 */
 ...
 *  \ingroup pico_stdio_uart_dma
 *
 * The DMA channel used is allocated dynamically.
 *
 ...
 */
void stdio_uart_dma_init_full(uart_inst_t *uart, uint baud_rate, int tx_pin, int rx_pin);
